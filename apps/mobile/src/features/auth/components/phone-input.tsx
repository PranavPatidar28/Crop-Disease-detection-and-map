...
export function PhoneInput({
  ...
  return (
    <View className={cn('gap-1.5', className)}>
      <View
        className={cn(
          'h-14 flex-row items-center overflow-hidden rounded-2xl border bg-surface px-1',
      ...
      >
        <Pressable
          ...
          className="h-12 flex-row items-center gap-1.5 rounded-xl bg-surface-elevated px-3"
          disabled
        >
          <Text className="text-base">🇮🇳</Text>
          <Text className="text-base font-semibold text-text">+91</Text>
        </Pressable>
